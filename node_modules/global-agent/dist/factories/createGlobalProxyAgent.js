...
const createConfiguration = configurationInput => {
  const defaultConfiguration = {
    ...
    // eslint-disable-next-line no-process-env
    forceGlobalAgent: typeof process.env.GLOBAL_AGENT_FORCE_GLOBAL_AGENT === 'string' ? (0, _boolean.default)(process.env.GLOBAL_AGENT_FORCE_GLOBAL_AGENT) : true
  };
...
const createGlobalProxyAgent = (configurationInput = defaultConfigurationInput) => {
  ...
  const BoundHttpProxyAgent = class extends _classes.HttpProxyAgent {
    constructor() {
      super(isProxyConfigured(getHttpProxy), mustUrlUseProxy(getHttpProxy), getUrlProxy(getHttpProxy), _http.default.globalAgent);
    }
  ...
  const BoundHttpsProxyAgent = class extends _classes.HttpsProxyAgent {
    constructor() {
      super(isProxyConfigured(getHttpsProxy), mustUrlUseProxy(getHttpsProxy), getUrlProxy(getHttpsProxy), _https.default.globalAgent);
    }
